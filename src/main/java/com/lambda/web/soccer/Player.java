...
public class Player {
    ...
    @Column(length = 20) private String joinYyyy;
    @Column(length = 20) private String position;
    @Column(length = 20) private String backNo;
    @Column(length = 20) private String nation;
    @Column(length = 20) private String birthDate;
    @Column(length = 20) private String solar;
    @Column(length = 20) private String height;
    @Column(length = 20) private String weight;

public Player(){};
Player(String playerId, String playerName, String ePlayerName,
                    String nickname,
                    String joinYyyy,
                    String position,
                    String backNo,
